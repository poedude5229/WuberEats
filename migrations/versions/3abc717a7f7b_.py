...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['owner_id'], [f'user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table(f'menu',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['restaurant_id'], [f'restaurant.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table(f'review',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['restaurant_id'], [f'restaurant.id'], ),
    sa.ForeignKeyConstraint(['user_id'], [f'user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table(f'carts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['menu_item_id'], [f'menu.id'], ),
    sa.ForeignKeyConstraint(['user_id'], [f'user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table(f'carts')
    op.drop_table(f'review')
    op.drop_table(f'menu')
    op.drop_table(f'restaurant')
    op.drop_table(f'user')
    # ### end Alembic commands ###
