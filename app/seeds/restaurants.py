...
def seed_restaurants():
    ...
    cuisine="Hardware",
    description="Ever since Joe was a young sigma Ohioan, he dreamt of owning a Menards. Now you can shop at his franchise location, why not get some nails and plywood for lunch? Wash it down with a crowbar", 
    ...
    cuisine="Mexican",
    description="Savor bold flavors with a variety of tacos, burritos, and quesadillas. Taco Bell delivers crave-worthy Mexican-inspired fast food with customizable options for every taste.", 
    hours_of_operation="Sunday-Saturday: 8AM-9PM",
    delivery_radius=3,
