...
def seed_restaurants():
    ...
    cuisine="Hardware",
    desciption="Ever since Joe was a young sigma Ohioan, he dreamt of owning a Menards. Now you can shop at his franchise location, why not get some nails and plywood for lunch? Wash it down with a crowbar", hours_of_operation="Sunday-Saturday: 8AM-9PM",
    delivery_radius=25,
    ...
    cuisine="American",
    desciption="Enjoy delicious, freshly prepared chicken sandwiches, nuggets, and waffle fries. Known for exceptional service and quality, Chick-fil-A offers a variety of tasty options for a satisfying meal.",
    ...
    cuisine="Mexican",
    desciption="Savor bold flavors with a variety of tacos, burritos, and quesadillas. Taco Bell delivers crave-worthy Mexican-inspired fast food with customizable options for every taste.", hours_of_operation="Sunday-Saturday: 8AM-9PM",
    delivery_radius=3,
    ...
    cuisine="American",
    desciption="Indulge in flame-grilled burgers, crispy fries, and a variety of tasty sides. Enjoy the iconic Whopper, chicken sandwiches, and refreshing drinks.",
    ...
    cuisine="American",
    desciption="Treat yourself to premium burgers, crinkle-cut fries, and hand-spun shakes. Shake Shack is known for its high-quality ingredients, mouthwatering flavors, and a menu that features both classic favorites and unique creations. Enjoy a delicious, upscale fast-food experience.",
    ...
    cuisine="American",
    desciption="Enjoy flavorful, freshly made chicken wings in a variety of mouthwatering sauces and seasonings. Wingstop offers classic wings, boneless wings, and tenders, along with tasty sides like seasoned fries and veggie sticks. Perfect for satisfying your wing cravings.",
    ...
    phone_number=3234561234,
    cuisine="Japanese",
    desciption="Experience fresh, high-quality sushi and sashimi with a creative twist. Angry Fish Sushi offers an array of delicious rolls, nigiri, and Japanese-inspired dishes, crafted with the finest ingredients. Perfect for sushi lovers seeking an exceptional dining experience.",
